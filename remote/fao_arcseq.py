# scripts for moving 
# python fao_arcseq.py cw cruise theta 10 1
import argparse
import yaml
import sys
sys.settrace
for path in ['/home/msdos/pb_svn/petalbox/trunk',
            '/home/msdos/pb_svn/petalbox/trunk/control',
            '/home/msdos/dos_home/dos_products']:
...
if __name__=='__main__':
 ...
 #   if speed=='cruise' and angle>100:
 #       print("DANGEROUS cruise and angle, shuting down")
 #       sys.exit()
 #   if cmdhash is None:
 #       print("No hash")
 #       sys.exit()
